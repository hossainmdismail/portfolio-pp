 ...
 <section class="about-personal background-section section-padding">
     ...
     <div class="container">
         <div class="content p-relative">
             <h2 class="title text-upper mt-20 dsn-fill">I CRAFT POWERFUL <br> WEBSITES WITH LARAVEL
                 <br>
                 PHP & WEBFLOW
             </h2>

             <svg class="svg-arrow p-absolute dsn-up" width="168" height="168" viewBox="0 0 168 168" fill="none"
             ...
             <div class="w-50 ml-auto">
                 ...
                 <div class="dsn-up">
                     <div class="dsn-btn dsn-btn-shape d-flex mt-30 ">
                         ...
                         <a class="button background-main v-dark effect-ajax" href="{{ route('about') }}">
