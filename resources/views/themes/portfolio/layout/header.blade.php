        ...
        <header id="site_menu_header" class="site-header d-none">
            <div class="main-logo">
                <a href="{{ route('home') }}" data-dsn-text="Home" class="custom-logo-link main-brand effect-ajax"
                    rel="home" aria-current="page">
                    <img src="{{ asset('themes/portfolio') }}/img/logo-light.png" class="custom-logo logo-light"
                        alt="Home" />
                    <img src="{{ asset('themes/portfolio') }}/img/logo.png" class="custom-logo logo-dark"
                        alt="Home" />
                </a>
            </div>
            <nav class="main-navigation ">
                ...
                <ul id="dsn-primary-list" class="primary-nav h2">
                    ...
                    <li class="nav-item ">
                        <a title="About" href="{{ route('about') }}">
