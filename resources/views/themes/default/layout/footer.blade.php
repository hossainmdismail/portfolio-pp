        ...
        <div class="row">
            <div class="col-md-12">
                <div class="footer__main">
                    ...
                    <div class="info-left">
                        <a href="{{ route('home') }}" class="logo"><img style="width:168px !important;"
                                src="{{ Storage::url($configData->logo) }}" alt=""></a>
                            ...
                            <div class="widget">
                                ...
                                <form action="#" class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button class=""><svg width="20" height="18" viewBox="0 0 20 18"
